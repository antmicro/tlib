...
#define DO_SUQADD_H(n, m) do_sat_bhs((int64_t)(int16_t)n + m, INT16_MIN, INT16_MAX)
#define DO_SUQADD_S(n, m) do_sat_bhs((int64_t)(int32_t)n + m, INT32_MIN, INT32_MAX)
...
#define DO_ZPZZ_PAIR_FP(NAME, TYPE, H, OP)                                                 \
    void HELPER(NAME)(void *vd, void *vn, void *vm, void *vg, void *status, uint32_t desc) \
    {                                                                                      \
        intptr_t i, opr_sz = simd_oprsz(desc);                                             \
        for(i = 0; i < opr_sz;) {                                                          \
            uint16_t pg = *(uint16_t *)(vg + H1_2(i >> 3));                                \
...
void HELPER(sve2_cdot_idx_s)(void *vd, void *vn, void *vm, void *va, uint32_t desc)
{
    ...
    for(int seg = 0; seg < opr_sz / 4; seg += 4) {
        ...
        for(int e = 0; e < 4; e++) {
            d[seg + e] = do_cdot_s(n[seg + e], seg_m, a[seg + e], sel_a, sel_b, sub_i);
        }
    }
}
...
void HELPER(sve2_cdot_idx_d)(void *vd, void *vn, void *vm, void *va, uint32_t desc)
{
    ...
    for(seg = 0; seg < opr_sz / 8; seg += 2) {
        ...
        for(int e = 0; e < 2; e++) {
            d[seg + e] = do_cdot_d(n[seg + e], seg_m, a[seg + e], sel_a, sel_b, sub_i);
        }
    }
}
...
#define DO_SQSHRUN_D(x, sh) do_sat_bhs((int64_t)(x) >> (sh < 64 ? sh : 63), 0, UINT32_MAX)
...
void HELPER(sve_fexpa_d)(void *vd, void *vn, uint32_t desc)
{
    ...
    static const uint64_t coeff[] = {
        0x0000000000000ull, 0x02C9A3E778061ull, 0x059B0D3158574ull, 0x0874518759BC8ull, 0x0B5586CF9890Full, 0x0E3EC32D3D1A2ull,
        0x11301D0125B51ull, 0x1429AAEA92DE0ull, 0x172B83C7D517Bull, 0x1A35BEB6FCB75ull, 0x1D4873168B9AAull, 0x2063B88628CD6ull,
        0x2387A6E756238ull, 0x26B4565E27CDDull, 0x29E9DF51FDEE1ull, 0x2D285A6E4030Bull, 0x306FE0A31B715ull, 0x33C08B26416FFull,
        0x371A7373AA9CBull, 0x3A7DB34E59FF7ull, 0x3DEA64C123422ull, 0x4160A21F72E2Aull, 0x44E086061892Dull, 0x486A2B5C13CD0ull,
        0x4BFDAD5362A27ull, 0x4F9B2769D2CA7ull, 0x5342B569D4F82ull, 0x56F4736B527DAull, 0x5AB07DD485429ull, 0x5E76F15AD2148ull,
        0x6247EB03A5585ull, 0x6623882552225ull, 0x6A09E667F3BCDull, 0x6DFB23C651A2Full, 0x71F75E8EC5F74ull, 0x75FEB564267C9ull,
        0x7A11473EB0187ull, 0x7E2F336CF4E62ull, 0x82589994CCE13ull, 0x868D99B4492EDull, 0x8ACE5422AA0DBull, 0x8F1AE99157736ull,
        0x93737B0CDC5E5ull, 0x97D829FDE4E50ull, 0x9C49182A3F090ull, 0xA0C667B5DE565ull, 0xA5503B23E255Dull, 0xA9E6B5579FDBFull,
        0xAE89F995AD3ADull, 0xB33A2B84F15FBull, 0xB7F76F2FB5E47ull, 0xBCC1E904BC1D2ull, 0xC199BDD85529Cull, 0xC67F12E57D14Bull,
        0xCB720DCEF9069ull, 0xD072D4A07897Cull, 0xD5818DCFBA487ull, 0xDA9E603DB3285ull, 0xDFC97337B9B5Full, 0xE502EE78B3FF6ull,
...
static uint32_t predtest_ones(ARMPredicateReg *d, intptr_t oprsz, uint64_t esz_mask)
{
    uint32_t flags = PREDTEST_INIT;
    intptr_t i;
...
uint64_t HELPER(sve_fadda_h)(uint64_t nn, void *vm, void *vg, void *status, uint32_t desc)
{
...
uint64_t HELPER(sve_fadda_s)(uint64_t nn, void *vm, void *vg, void *status, uint32_t desc)
{
    intptr_t i = 0, opr_sz = simd_oprsz(desc);
    float32 result = nn;
...
uint64_t HELPER(sve_fadda_d)(uint64_t nn, void *vm, void *vg, void *status, uint32_t desc)
{
...
#define DO_ZPZS_FP(NAME, TYPE, H, OP)                                                             \
    void HELPER(NAME)(void *vd, void *vn, void *vg, uint64_t scalar, void *status, uint32_t desc) \
    {                                                                                             \
        intptr_t i = simd_oprsz(desc);                                                            \
        uint64_t *g = vg;                                                                         \
        TYPE mm = scalar;                                                                         \
...
static void do_fmla_zpzzz_h(void *vd, void *vn, void *vm, void *va, void *vg, float_status *status, uint32_t desc, uint16_t neg1,
                            uint16_t neg3)
{
    intptr_t i = simd_oprsz(desc);
    uint64_t *g = vg;
...
void HELPER(sve_fmla_zpzzz_h)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_h(vd, vn, vm, va, vg, status, desc, 0, 0);
}

void HELPER(sve_fmls_zpzzz_h)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_h(vd, vn, vm, va, vg, status, desc, 0x8000, 0);
}

void HELPER(sve_fnmla_zpzzz_h)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_h(vd, vn, vm, va, vg, status, desc, 0x8000, 0x8000);
}

void HELPER(sve_fnmls_zpzzz_h)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_h(vd, vn, vm, va, vg, status, desc, 0, 0x8000);
}

static void do_fmla_zpzzz_s(void *vd, void *vn, void *vm, void *va, void *vg, float_status *status, uint32_t desc, uint32_t neg1,
                            uint32_t neg3)
{
    intptr_t i = simd_oprsz(desc);
    uint64_t *g = vg;
...
void HELPER(sve_fmla_zpzzz_s)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_s(vd, vn, vm, va, vg, status, desc, 0, 0);
}

void HELPER(sve_fmls_zpzzz_s)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_s(vd, vn, vm, va, vg, status, desc, 0x80000000, 0);
}

void HELPER(sve_fnmla_zpzzz_s)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_s(vd, vn, vm, va, vg, status, desc, 0x80000000, 0x80000000);
}

void HELPER(sve_fnmls_zpzzz_s)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_s(vd, vn, vm, va, vg, status, desc, 0, 0x80000000);
}

static void do_fmla_zpzzz_d(void *vd, void *vn, void *vm, void *va, void *vg, float_status *status, uint32_t desc, uint64_t neg1,
                            uint64_t neg3)
{
    intptr_t i = simd_oprsz(desc);
    uint64_t *g = vg;
...
void HELPER(sve_fmla_zpzzz_d)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_d(vd, vn, vm, va, vg, status, desc, 0, 0);
}

void HELPER(sve_fmls_zpzzz_d)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_d(vd, vn, vm, va, vg, status, desc, INT64_MIN, 0);
}

void HELPER(sve_fnmla_zpzzz_d)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    do_fmla_zpzzz_d(vd, vn, vm, va, vg, status, desc, INT64_MIN, INT64_MIN);
}

void HELPER(sve_fnmls_zpzzz_d)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
...
void HELPER(sve_fcadd_h)(void *vd, void *vn, void *vm, void *vg, void *vs, uint32_t desc)
{
...
void HELPER(sve_fcadd_s)(void *vd, void *vn, void *vm, void *vg, void *vs, uint32_t desc)
{
    intptr_t j, i = simd_oprsz(desc);
    uint64_t *g = vg;
...
void HELPER(sve_fcadd_d)(void *vd, void *vn, void *vm, void *vg, void *vs, uint32_t desc)
{
    intptr_t j, i = simd_oprsz(desc);
    uint64_t *g = vg;
...
void HELPER(sve_fcmla_zpzzz_h)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    intptr_t j, i = simd_oprsz(desc);
...
void HELPER(sve_fcmla_zpzzz_s)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    intptr_t j, i = simd_oprsz(desc);
    unsigned rot = simd_data(desc);
    bool flip = rot & 1;
...
void HELPER(sve_fcmla_zpzzz_d)(void *vd, void *vn, void *vm, void *va, void *vg, void *status, uint32_t desc)
{
    intptr_t j, i = simd_oprsz(desc);
    unsigned rot = simd_data(desc);
    bool flip = rot & 1;
                    ...
                    int mmu_idx, uintptr_t retaddr)
{
    ...
    flags = probe_access_flags(env, addr, access_type, mmu_idx, nofault, &info->host, retaddr);
    info->flags = flags;
     ...
     */
    {
        ...
        target_ulong comparator = (access_type == MMU_DATA_LOAD ? entry->addr_read : entry->addr_write);
 ...
 */
static inline void sve_ldN_r(CPUARMState *env, uint64_t *vg, const target_ulong addr, uint32_t desc, const uintptr_t retaddr,
                             const int esz, const int msz, const int N, uint32_t mtedesc, sve_ldst1_host_fn *host_fn,
                             sve_ldst1_tlb_fn *tlb_fn)
{
     ...
     */
    if(mtedesc) {
        sve_cont_ldst_mte_check(&info, env, vg, addr, 1 << esz, N << msz, mtedesc, retaddr);
    }
    ...
    if(unlikely(flags != 0)) {
        ...
        do {
            ...
            do {
                if((pg >> (reg_off & 63)) & 1) {
                    for(i = 0; i < N; ++i) {
                        tlb_fn(env, &scratch[i], reg_off, addr + mem_off + (i << msz), retaddr);
                    }
                }
                reg_off += 1 << esz;
                mem_off += N << msz;
...
static inline void sve_ldN_r_mte(CPUARMState *env, uint64_t *vg, target_ulong addr, uint32_t desc, const uintptr_t ra,
                                 const int esz, const int msz, const int N, sve_ldst1_host_fn *host_fn, sve_ldst1_tlb_fn *tlb_fn)
{
    ...
    if(!tbi_check(desc, bit55) || tcma_check(desc, bit55, allocation_tag_from_addr(addr))) {
        mtedesc = 0;
    }
...
#define DO_LD1_1(NAME, ESZ)                                                                                 \
    void HELPER(sve_##NAME##_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)              \
    {                                                                                                       \
        sve_ldN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, MO_8, 1, 0, sve_##NAME##_host, sve_##NAME##_tlb);  \
    }                                                                                                       \
    void HELPER(sve_##NAME##_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)          \
    {                                                                                                       \
        sve_ldN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MO_8, 1, sve_##NAME##_host, sve_##NAME##_tlb); \
    }

#define DO_LD1_2(NAME, ESZ, MSZ)                                                                                 \
    void HELPER(sve_##NAME##_le_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                \
    {                                                                                                            \
        sve_ldN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, 1, 0, sve_##NAME##_le_host, sve_##NAME##_le_tlb);  \
    }                                                                                                            \
    void HELPER(sve_##NAME##_be_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                \
    {                                                                                                            \
        sve_ldN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, 1, 0, sve_##NAME##_be_host, sve_##NAME##_be_tlb);  \
    }                                                                                                            \
    void HELPER(sve_##NAME##_le_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)            \
    {                                                                                                            \
        sve_ldN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, 1, sve_##NAME##_le_host, sve_##NAME##_le_tlb); \
    }                                                                                                            \
    void HELPER(sve_##NAME##_be_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)            \
    {                                                                                                            \
        sve_ldN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, 1, sve_##NAME##_be_host, sve_##NAME##_be_tlb); \
    }
...
#define DO_LDN_1(N)                                                                                    \
    void HELPER(sve_ld##N##bb_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)        \
    {                                                                                                  \
        sve_ldN_r(env, vg, addr, desc, ARM_GETPC(), MO_8, MO_8, N, 0, sve_ld1bb_host, sve_ld1bb_tlb);  \
    }                                                                                                  \
    void HELPER(sve_ld##N##bb_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)    \
    {                                                                                                  \
        sve_ldN_r_mte(env, vg, addr, desc, ARM_GETPC(), MO_8, MO_8, N, sve_ld1bb_host, sve_ld1bb_tlb); \
    }

#define DO_LDN_2(N, SUFF, ESZ)                                                                                         \
    void HELPER(sve_ld##N##SUFF##_le_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                 \
    {                                                                                                                  \
        sve_ldN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, ESZ, N, 0, sve_ld1##SUFF##_le_host, sve_ld1##SUFF##_le_tlb);  \
    }                                                                                                                  \
    void HELPER(sve_ld##N##SUFF##_be_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                 \
    {                                                                                                                  \
        sve_ldN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, ESZ, N, 0, sve_ld1##SUFF##_be_host, sve_ld1##SUFF##_be_tlb);  \
    }                                                                                                                  \
    void HELPER(sve_ld##N##SUFF##_le_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)             \
    {                                                                                                                  \
        sve_ldN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, ESZ, N, sve_ld1##SUFF##_le_host, sve_ld1##SUFF##_le_tlb); \
    }                                                                                                                  \
    void HELPER(sve_ld##N##SUFF##_be_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)             \
    {                                                                                                                  \
        sve_ldN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, ESZ, N, sve_ld1##SUFF##_be_host, sve_ld1##SUFF##_be_tlb); \
    }
 ...
 */
static inline void sve_ldnfff1_r(CPUARMState *env, void *vg, const target_ulong addr, uint32_t desc, const uintptr_t retaddr,
                                 uint32_t mtedesc, const int esz, const int msz, const SVEContFault fault,
...
static inline void sve_ldnfff1_r_mte(CPUARMState *env, void *vg, target_ulong addr, uint32_t desc, const uintptr_t retaddr,
                                     const int esz, const int msz, const SVEContFault fault, sve_ldst1_host_fn *host_fn,
                                     sve_ldst1_tlb_fn *tlb_fn)
{
    uint32_t mtedesc = desc >> (SIMD_DATA_SHIFT + SVE_MTEDESC_SHIFT);
    int bit55 = extract64(addr, 55, 1);
...
#define DO_LDFF1_LDNF1_1(PART, ESZ)                                                                                             \
    void HELPER(sve_ldff1##PART##_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                             \
    {                                                                                                                           \
        sve_ldnfff1_r(env, vg, addr, desc, ARM_GETPC(), 0, ESZ, MO_8, FAULT_FIRST, sve_ld1##PART##_host, sve_ld1##PART##_tlb);  \
    }                                                                                                                           \
    void HELPER(sve_ldnf1##PART##_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                             \
    {                                                                                                                           \
        sve_ldnfff1_r(env, vg, addr, desc, ARM_GETPC(), 0, ESZ, MO_8, FAULT_NO, sve_ld1##PART##_host, sve_ld1##PART##_tlb);     \
    }                                                                                                                           \
    void HELPER(sve_ldff1##PART##_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                         \
    {                                                                                                                           \
        sve_ldnfff1_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MO_8, FAULT_FIRST, sve_ld1##PART##_host, sve_ld1##PART##_tlb); \
    }                                                                                                                           \
    void HELPER(sve_ldnf1##PART##_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                         \
    {                                                                                                                           \
        sve_ldnfff1_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MO_8, FAULT_NO, sve_ld1##PART##_host, sve_ld1##PART##_tlb);    \
    }

#define DO_LDFF1_LDNF1_2(PART, ESZ, MSZ)                                                                                         \
    void HELPER(sve_ldff1##PART##_le_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                           \
    {                                                                                                                            \
        sve_ldnfff1_r(env, vg, addr, desc, ARM_GETPC(), 0, ESZ, MSZ, FAULT_FIRST, sve_ld1##PART##_le_host,                       \
                      sve_ld1##PART##_le_tlb);                                                                                   \
    }                                                                                                                            \
    void HELPER(sve_ldnf1##PART##_le_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                           \
    {                                                                                                                            \
        sve_ldnfff1_r(env, vg, addr, desc, ARM_GETPC(), 0, ESZ, MSZ, FAULT_NO, sve_ld1##PART##_le_host, sve_ld1##PART##_le_tlb); \
    }                                                                                                                            \
    void HELPER(sve_ldff1##PART##_be_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                           \
    {                                                                                                                            \
        sve_ldnfff1_r(env, vg, addr, desc, ARM_GETPC(), 0, ESZ, MSZ, FAULT_FIRST, sve_ld1##PART##_be_host,                       \
                      sve_ld1##PART##_be_tlb);                                                                                   \
    }                                                                                                                            \
    void HELPER(sve_ldnf1##PART##_be_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                           \
    {                                                                                                                            \
        sve_ldnfff1_r(env, vg, addr, desc, ARM_GETPC(), 0, ESZ, MSZ, FAULT_NO, sve_ld1##PART##_be_host, sve_ld1##PART##_be_tlb); \
    }                                                                                                                            \
    void HELPER(sve_ldff1##PART##_le_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                       \
    {                                                                                                                            \
        sve_ldnfff1_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, FAULT_FIRST, sve_ld1##PART##_le_host,                      \
                          sve_ld1##PART##_le_tlb);                                                                               \
    }                                                                                                                            \
    void HELPER(sve_ldnf1##PART##_le_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                       \
    {                                                                                                                            \
        sve_ldnfff1_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, FAULT_NO, sve_ld1##PART##_le_host,                         \
                          sve_ld1##PART##_le_tlb);                                                                               \
    }                                                                                                                            \
    void HELPER(sve_ldff1##PART##_be_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                       \
    {                                                                                                                            \
        sve_ldnfff1_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, FAULT_FIRST, sve_ld1##PART##_be_host,                      \
                          sve_ld1##PART##_be_tlb);                                                                               \
    }                                                                                                                            \
    void HELPER(sve_ldnf1##PART##_be_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                       \
    {                                                                                                                            \
        sve_ldnfff1_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, FAULT_NO, sve_ld1##PART##_be_host,                         \
                          sve_ld1##PART##_be_tlb);                                                                               \
    }
...
static inline void sve_stN_r(CPUARMState *env, uint64_t *vg, target_ulong addr, uint32_t desc, const uintptr_t retaddr,
                             const int esz, const int msz, const int N, uint32_t mtedesc, sve_ldst1_host_fn *host_fn,
                             sve_ldst1_tlb_fn *tlb_fn)
{
    const unsigned rd = simd_data(desc);
...
static inline void sve_stN_r_mte(CPUARMState *env, uint64_t *vg, target_ulong addr, uint32_t desc, const uintptr_t ra,
                                 const int esz, const int msz, const int N, sve_ldst1_host_fn *host_fn, sve_ldst1_tlb_fn *tlb_fn)
{
    uint32_t mtedesc = desc >> (SIMD_DATA_SHIFT + SVE_MTEDESC_SHIFT);
    int bit55 = extract64(addr, 55, 1);
...
#define DO_STN_1(N, NAME, ESZ)                                                                                    \
    void HELPER(sve_st##N##NAME##_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)               \
    {                                                                                                             \
        sve_stN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, MO_8, N, 0, sve_st1##NAME##_host, sve_st1##NAME##_tlb);  \
    }                                                                                                             \
    void HELPER(sve_st##N##NAME##_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)           \
    {                                                                                                             \
        sve_stN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MO_8, N, sve_st1##NAME##_host, sve_st1##NAME##_tlb); \
    }

#define DO_STN_2(N, NAME, ESZ, MSZ)                                                                                    \
    void HELPER(sve_st##N##NAME##_le_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                 \
    {                                                                                                                  \
        sve_stN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, N, 0, sve_st1##NAME##_le_host, sve_st1##NAME##_le_tlb);  \
    }                                                                                                                  \
    void HELPER(sve_st##N##NAME##_be_r)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)                 \
    {                                                                                                                  \
        sve_stN_r(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, N, 0, sve_st1##NAME##_be_host, sve_st1##NAME##_be_tlb);  \
    }                                                                                                                  \
    void HELPER(sve_st##N##NAME##_le_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)             \
    {                                                                                                                  \
        sve_stN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, N, sve_st1##NAME##_le_host, sve_st1##NAME##_le_tlb); \
    }                                                                                                                  \
    void HELPER(sve_st##N##NAME##_be_r_mte)(CPUARMState * env, void *vg, target_ulong addr, uint32_t desc)             \
    {                                                                                                                  \
        sve_stN_r_mte(env, vg, addr, desc, ARM_GETPC(), ESZ, MSZ, N, sve_st1##NAME##_be_host, sve_st1##NAME##_be_tlb); \
    }
...
static inline void sve_ld1_z(CPUARMState *env, void *vd, uint64_t *vg, void *vm, target_ulong base, uint32_t desc,
                             uintptr_t retaddr, uint32_t mtedesc, int esize, int msize, zreg_off_fn *off_fn,
                             sve_ldst1_host_fn *host_fn, sve_ldst1_tlb_fn *tlb_fn)
{
...
static inline void sve_ld1_z_mte(CPUARMState *env, void *vd, uint64_t *vg, void *vm, target_ulong base, uint32_t desc,
                                 uintptr_t retaddr, int esize, int msize, zreg_off_fn *off_fn, sve_ldst1_host_fn *host_fn,
                                 sve_ldst1_tlb_fn *tlb_fn)
{
    uint32_t mtedesc = desc >> (SIMD_DATA_SHIFT + SVE_MTEDESC_SHIFT);
    /* Remove mtedesc from the normal sve descriptor. */
...
#define DO_LD1_ZPZ_S(MEM, OFS, MSZ)                                                                                           \
    void HELPER(sve_ld##MEM##_##OFS)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc)       \
    {                                                                                                                         \
        sve_ld1_z(env, vd, vg, vm, base, desc, ARM_GETPC(), 0, 4, 1 << MSZ, off_##OFS##_s, sve_ld1##MEM##_host,               \
                  sve_ld1##MEM##_tlb);                                                                                        \
    }                                                                                                                         \
    void HELPER(sve_ld##MEM##_##OFS##_mte)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc) \
    {                                                                                                                         \
        sve_ld1_z_mte(env, vd, vg, vm, base, desc, ARM_GETPC(), 4, 1 << MSZ, off_##OFS##_s, sve_ld1##MEM##_host,              \
                      sve_ld1##MEM##_tlb);                                                                                    \
    }
...
#define DO_LD1_ZPZ_D(MEM, OFS, MSZ)                                                                                           \
    void HELPER(sve_ld##MEM##_##OFS)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc)       \
    {                                                                                                                         \
        sve_ld1_z(env, vd, vg, vm, base, desc, ARM_GETPC(), 0, 8, 1 << MSZ, off_##OFS##_d, sve_ld1##MEM##_host,               \
                  sve_ld1##MEM##_tlb);                                                                                        \
    }                                                                                                                         \
    void HELPER(sve_ld##MEM##_##OFS##_mte)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc) \
    {                                                                                                                         \
        sve_ld1_z_mte(env, vd, vg, vm, base, desc, ARM_GETPC(), 8, 1 << MSZ, off_##OFS##_d, sve_ld1##MEM##_host,              \
                      sve_ld1##MEM##_tlb);                                                                                    \
    }
...
static inline void sve_ldff1_z(CPUARMState *env, void *vd, uint64_t *vg, void *vm, target_ulong base, uint32_t desc,
                               uintptr_t retaddr, uint32_t mtedesc, const int esz, const int msz, zreg_off_fn *off_fn,
                               sve_ldst1_host_fn *host_fn, sve_ldst1_tlb_fn *tlb_fn)
{
    const int mmu_idx = cpu_mmu_index(env);
    const intptr_t reg_max = simd_oprsz(desc);
    ...
    while(reg_off < reg_max) {
        ...
        do {
            if(likely((pg >> (reg_off & 63)) & 1)) {
                ...
                if(mtedesc && arm_tlb_mte_tagged(&info.attrs) && !mte_probe(env, mtedesc, addr)) {
                    goto fault;
                }
...
static inline void sve_ldff1_z_mte(CPUARMState *env, void *vd, uint64_t *vg, void *vm, target_ulong base, uint32_t desc,
                                   uintptr_t retaddr, const int esz, const int msz, zreg_off_fn *off_fn,
                                   sve_ldst1_host_fn *host_fn, sve_ldst1_tlb_fn *tlb_fn)
{
    uint32_t mtedesc = desc >> (SIMD_DATA_SHIFT + SVE_MTEDESC_SHIFT);
    /* Remove mtedesc from the normal sve descriptor. */
...
#define DO_LDFF1_ZPZ_S(MEM, OFS, MSZ)                                                                                           \
    void HELPER(sve_ldff##MEM##_##OFS)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc)       \
    {                                                                                                                           \
        sve_ldff1_z(env, vd, vg, vm, base, desc, ARM_GETPC(), 0, MO_32, MSZ, off_##OFS##_s, sve_ld1##MEM##_host,                \
                    sve_ld1##MEM##_tlb);                                                                                        \
    }                                                                                                                           \
    void HELPER(sve_ldff##MEM##_##OFS##_mte)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc) \
    {                                                                                                                           \
        sve_ldff1_z_mte(env, vd, vg, vm, base, desc, ARM_GETPC(), MO_32, MSZ, off_##OFS##_s, sve_ld1##MEM##_host,               \
                        sve_ld1##MEM##_tlb);                                                                                    \
    }
...
#define DO_LDFF1_ZPZ_D(MEM, OFS, MSZ)                                                                                           \
    void HELPER(sve_ldff##MEM##_##OFS)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc)       \
    {                                                                                                                           \
        sve_ldff1_z(env, vd, vg, vm, base, desc, ARM_GETPC(), 0, MO_64, MSZ, off_##OFS##_d, sve_ld1##MEM##_host,                \
                    sve_ld1##MEM##_tlb);                                                                                        \
    }                                                                                                                           \
    void HELPER(sve_ldff##MEM##_##OFS##_mte)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc) \
    {                                                                                                                           \
        sve_ldff1_z_mte(env, vd, vg, vm, base, desc, ARM_GETPC(), MO_64, MSZ, off_##OFS##_d, sve_ld1##MEM##_host,               \
                        sve_ld1##MEM##_tlb);                                                                                    \
    }
...
static inline void sve_st1_z(CPUARMState *env, void *vd, uint64_t *vg, void *vm, target_ulong base, uint32_t desc,
                             uintptr_t retaddr, uint32_t mtedesc, int esize, int msize, zreg_off_fn *off_fn,
                             sve_ldst1_host_fn *host_fn, sve_ldst1_tlb_fn *tlb_fn)
{
    const int mmu_idx = cpu_mmu_index(env);
...
static inline void sve_st1_z_mte(CPUARMState *env, void *vd, uint64_t *vg, void *vm, target_ulong base, uint32_t desc,
                                 uintptr_t retaddr, int esize, int msize, zreg_off_fn *off_fn, sve_ldst1_host_fn *host_fn,
                                 sve_ldst1_tlb_fn *tlb_fn)
{
    uint32_t mtedesc = desc >> (SIMD_DATA_SHIFT + SVE_MTEDESC_SHIFT);
...
#define DO_ST1_ZPZ_S(MEM, OFS, MSZ)                                                                                           \
    void HELPER(sve_st##MEM##_##OFS)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc)       \
    {                                                                                                                         \
        sve_st1_z(env, vd, vg, vm, base, desc, ARM_GETPC(), 0, 4, 1 << MSZ, off_##OFS##_s, sve_st1##MEM##_host,               \
                  sve_st1##MEM##_tlb);                                                                                        \
    }                                                                                                                         \
    void HELPER(sve_st##MEM##_##OFS##_mte)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc) \
    {                                                                                                                         \
        sve_st1_z_mte(env, vd, vg, vm, base, desc, ARM_GETPC(), 4, 1 << MSZ, off_##OFS##_s, sve_st1##MEM##_host,              \
                      sve_st1##MEM##_tlb);                                                                                    \
    }
...
#define DO_ST1_ZPZ_D(MEM, OFS, MSZ)                                                                                           \
    void HELPER(sve_st##MEM##_##OFS)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc)       \
    {                                                                                                                         \
        sve_st1_z(env, vd, vg, vm, base, desc, ARM_GETPC(), 0, 8, 1 << MSZ, off_##OFS##_d, sve_st1##MEM##_host,               \
                  sve_st1##MEM##_tlb);                                                                                        \
    }                                                                                                                         \
    void HELPER(sve_st##MEM##_##OFS##_mte)(CPUARMState * env, void *vd, void *vg, void *vm, target_ulong base, uint32_t desc) \
    {                                                                                                                         \
        sve_st1_z_mte(env, vd, vg, vm, base, desc, ARM_GETPC(), 8, 1 << MSZ, off_##OFS##_d, sve_st1##MEM##_host,              \
                      sve_st1##MEM##_tlb);                                                                                    \
    }
...
void HELPER(fmmla_s)(void *vd, void *vn, void *vm, void *va, void *status, uint32_t desc)
{
...
void HELPER(fmmla_d)(void *vd, void *vn, void *vm, void *va, void *status, uint32_t desc)
{

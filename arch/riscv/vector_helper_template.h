...
void glue(helper_vmslt_ivi, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int i = 0; i < env->vl; ++i) {
        ...
        switch (eew) {
        case 8:
            V(vd)[i >> 3] |= (((int8_t *)V(vs2))[i] < rs1) << (i & 0x7);
            break;
        case 16:
            V(vd)[i >> 3] |= (((int16_t *)V(vs2))[i] < rs1) << (i & 0x7);
            break;
        case 32:
            V(vd)[i >> 3] |= (((int32_t *)V(vs2))[i] < rs1) << (i & 0x7);
            break;
        case 64:
            V(vd)[i >> 3] |= (((int64_t *)V(vs2))[i] < rs1) << (i & 0x7);
            break;
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
            break;
...
void glue(helper_vmadd_mvx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        switch (eew) {
        case 8:
            ((int8_t *)V(vd))[ei] = (((int8_t *)V(vd))[ei] * rs1) + ((int8_t *)V(vs2))[ei];
            break;
        case 16:
            ((int16_t *)V(vd))[ei] = (((int16_t *)V(vd))[ei] * rs1) + ((int16_t *)V(vs2))[ei];
            break;
        case 32:
            ((int32_t *)V(vd))[ei] = (((int32_t *)V(vd))[ei] * rs1) + ((int32_t *)V(vs2))[ei];
            break;
        case 64:
            ((int64_t *)V(vd))[ei] = (((int64_t *)V(vd))[ei] * rs1) + ((int64_t *)V(vs2))[ei];
            break;
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
            break;
...
void glue(helper_vwmaccu_mvx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_ulong rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        switch (eew) {
        case 8:
            ((uint16_t *)V(vd))[ei] += (uint16_t)((uint8_t *)V(vs2))[ei] * rs1;
            break;
        case 16:
            ((uint32_t *)V(vd))[ei] += (uint32_t)((uint16_t *)V(vs2))[ei] * rs1;
            break;
        case 32:
            ((uint64_t *)V(vd))[ei] += (uint64_t)((uint32_t *)V(vs2))[ei] * rs1;
            break;
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
            break;
...
void glue(helper_vwmacc_mvx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        switch (eew) {
        case 8:
            ((int16_t *)V(vd))[ei] += (int16_t)((int8_t *)V(vs2))[ei] * rs1;
            break;
        case 16:
            ((int32_t *)V(vd))[ei] += (int32_t)((int16_t *)V(vs2))[ei] * rs1;
            break;
        case 32:
            ((int64_t *)V(vd))[ei] += (int64_t)((int32_t *)V(vs2))[ei] * rs1;
            break;
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
            break;
...
void glue(helper_vwmaccsu_mvx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        switch (eew) {
        case 8:
            ((int16_t *)V(vd))[ei] += (uint16_t)((uint8_t *)V(vs2))[ei] * rs1;
            break;
        case 16:
            ((int32_t *)V(vd))[ei] += (uint32_t)((uint16_t *)V(vs2))[ei] * rs1;
            break;
        case 32:
            ((int64_t *)V(vd))[ei] += (uint64_t)((uint32_t *)V(vs2))[ei] * rs1;
            break;
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
            break;
...
void glue(helper_vmerge_ivv, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, int32_t vs1)
{
    if (V_IDX_INVALID(vd) || V_IDX_INVALID(vs2) || V_IDX_INVALID(vs1)) {
        helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
    }
...
void glue(helper_vmerge_ivi, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    if (V_IDX_INVALID(vd) || V_IDX_INVALID(vs2)) {
        helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
    }
...
void glue(helper_vsaddu_ivi, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_ulong rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        switch (eew) {
        case 8: {
                uint8_t ab = ((uint8_t *)V(vs2))[ei] + rs1;
                uint8_t sat = ab < rs1;
                env->vxsat |= sat;
                ((uint8_t *)V(vd))[ei] = sat ? ~0 : ab;
                break;
        ...
        case 16: {
                uint16_t ab = ((uint16_t *)V(vs2))[ei] + rs1;
                uint8_t sat = ab < rs1;
                env->vxsat |= sat;
                ((uint16_t *)V(vd))[ei] = sat ? ~0 : ab;
                break;
        ...
        case 32: {
                uint32_t ab = ((uint32_t *)V(vs2))[ei] + rs1;
                uint8_t sat = ab < rs1;
                env->vxsat |= sat;
                ((uint32_t *)V(vd))[ei] = sat ? ~0 : ab;
                break;
        ...
        case 64: {
                uint64_t ab = ((uint64_t *)V(vs2))[ei] + rs1;
                uint8_t sat = ab < rs1;
                env->vxsat |= sat;
                ((uint64_t *)V(vd))[ei] = sat ? ~0 : ab;
                break;
...
void glue(helper_vsadd_ivi, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        case 8: {
                int8_t a = ((int8_t *)V(vs2))[ei];
                int8_t sat_value = INT8_MAX + (a < 0);
                uint8_t sat = (a < 0) != (rs1 > sat_value - a);
                env->vxsat |= sat;
                ((int8_t *)V(vd))[ei] = sat ? sat_value : a + rs1;
                break;
            }
        case 16: {
                int16_t a = ((int16_t *)V(vs2))[ei];
                ...
                uint8_t sat = (a < 0) != (rs1 > sat_value - a);
                env->vxsat |= sat;
                ((int16_t *)V(vd))[ei] = sat ? sat_value : a + rs1;
                break;
            }
        case 32: {
                int32_t a = ((int32_t *)V(vs2))[ei];
                ...
                uint8_t sat = (a < 0) != (rs1 > sat_value - a);
                env->vxsat |= sat;
                ((int32_t *)V(vd))[ei] = sat ? sat_value : a + rs1;
                break;
            }
        case 64: {
                int64_t a = ((int64_t *)V(vs2))[ei];
                ...
                uint8_t sat = (a < 0) != (rs1 > sat_value - a);
                env->vxsat |= sat;
                ((int64_t *)V(vd))[ei] = sat ? sat_value : a + rs1;
                break;
            }
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
...
void glue(helper_vssub_ivi, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        case 8: {
                int8_t a = ((int8_t *)V(vs2))[ei];
                int8_t sat_value = INT8_MAX + (a < 0);
                uint8_t sat = rs1 < 0 ? a < 0 && rs1 - 1 > sat_value + a : a >= 0 && rs1 <= sat_value + a;
                env->vxsat |= sat;
                ((int8_t *)V(vd))[ei] = sat ? sat_value : a - rs1;
                break;
            }
...
void glue(helper_vaadd_mvx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        case 8: {
                int16_t a = ((int8_t *)V(vs2))[ei];
                ((int8_t *)V(vd))[ei] = roundoff_i16(a + rs1, 1, rm);
                break;
            }
        case 16: {
                int32_t a = ((int16_t *)V(vs2))[ei];
                ((int16_t *)V(vd))[ei] = roundoff_i32(a + rs1, 1, rm);
                break;
            }
        case 32: {
                int64_t a = ((int32_t *)V(vs2))[ei];
                ((int32_t *)V(vd))[ei] = roundoff_i64(a + rs1, 1, rm);
                break;
            }
        case 64: {
                __int128_t a = ((int64_t *)V(vs2))[ei];
                ((int64_t *)V(vd))[ei] = roundoff_i128(a + rs1, 1, rm);
                break;
            }
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
...
void glue(helper_vaaddu_mvx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_ulong rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        case 8: {
                uint16_t a = ((uint8_t *)V(vs2))[ei];
                ((uint8_t *)V(vd))[ei] = roundoff_u16(a + rs1, 1, rm);
                break;
            }
        case 16: {
                uint32_t a = ((uint16_t *)V(vs2))[ei];
                ((uint16_t *)V(vd))[ei] = roundoff_u32(a + rs1, 1, rm);
                break;
            }
        case 32: {
                uint64_t a = ((uint32_t *)V(vs2))[ei];
                ((uint32_t *)V(vd))[ei] = roundoff_u64(a + rs1, 1, rm);
                break;
            }
        case 64: {
                __uint128_t a = ((uint64_t *)V(vs2))[ei];
                ((uint64_t *)V(vd))[ei] = roundoff_u128(a + rs1, 1, rm);
                break;
            }
        default:
            helper_raise_exception(env, RISCV_EXCP_ILLEGAL_INST);
...
void glue(helper_vsmul_ivx, POSTFIX)(CPUState *env, uint32_t vd, int32_t vs2, target_long rs1)
{
    ...
    for (int ei = env->vstart; ei < env->vl; ++ei) {
        ...
        case 8: {
                int16_t a = ((int8_t *)V(vs2))[ei];
                int16_t res = roundoff_i16(a * rs1, shift, rm);
                if (res < INT8_MIN) {
                    res = INT8_MIN;
                    env->vxsat |= 1;
                } else if (res > INT8_MAX) {
        ...
        case 16: {
                int32_t a = ((int16_t *)V(vs2))[ei];
                int32_t res = roundoff_i32(a * rs1, shift, rm);
                if (res < INT16_MIN) {
                    res = INT16_MIN;
                    env->vxsat |= 1;
                } else if (res > INT16_MAX) {
        ...
        case 32: {
                int64_t a = ((int32_t *)V(vs2))[ei];
                int64_t res = roundoff_i64(a * rs1, shift, rm);
                if (res < INT32_MIN) {
                    res = INT32_MIN;
                    env->vxsat |= 1;
                } else if (res > INT32_MAX) {
        ...
        case 64: {
                __int128_t a = ((int64_t *)V(vs2))[ei];
                __int128_t res = roundoff_i128(a * rs1, shift, rm);
                if (res < INT64_MIN) {
                    res = INT64_MIN;
                    env->vxsat |= 1;
                } else if (res > INT64_MAX) {

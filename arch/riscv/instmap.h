...
enum {
    OPC_RISC_LR_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x02 << 27),
    OPC_RISC_SC_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x03 << 27),
    OPC_RISC_AMOSWAP_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x01 << 27),
    OPC_RISC_AMOADD_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x00 << 27),
    OPC_RISC_AMOXOR_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x04 << 27),
    OPC_RISC_AMOAND_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x0C << 27),
    OPC_RISC_AMOOR_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x08 << 27),
    OPC_RISC_AMOMIN_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x10 << 27),
    OPC_RISC_AMOMAX_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x14 << 27),
    OPC_RISC_AMOMINU_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x18 << 27),
    OPC_RISC_AMOMAXU_W = OPC_RISC_ATOMIC | FUNCT3_WORD << 12 | (0x1C << 27),

    OPC_RISC_LR_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x02 << 27),
    OPC_RISC_SC_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x03 << 27),
    OPC_RISC_AMOSWAP_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x01 << 27),
    OPC_RISC_AMOADD_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x00 << 27),
    OPC_RISC_AMOXOR_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x04 << 27),
    OPC_RISC_AMOAND_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x0C << 27),
    OPC_RISC_AMOOR_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x08 << 27),
    OPC_RISC_AMOMIN_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x10 << 27),
    OPC_RISC_AMOMAX_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x14 << 27),
    OPC_RISC_AMOMINU_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x18 << 27),
    OPC_RISC_AMOMAXU_D = OPC_RISC_ATOMIC | FUNCT3_DOUBLEWORD << 12 | (0x1C << 27),
};

enum {
    AMOCAS = 0x05 << 27,

    OPC_RISC_AMOCAS = OPC_RISC_ATOMIC | AMOCAS,

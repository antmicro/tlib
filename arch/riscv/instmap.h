...
enum {
    ...
    /* Zbkb: */
    OPC_RISC_ZIP = OPC_RISC_ARITH_IMM | (0x1 << 12) | (0x8F << 20),
...
enum {
    ...
    OPC_RISC_BREV8 = OPC_RISC_ARITH_IMM | (0x5 << 12) | (0x687 << 20),

    /* Zbkb: */
    OPC_RISC_UNZIP = OPC_RISC_ARITH_IMM | (0x5 << 12) | (0x8F << 20),
};
...
enum {
    ...
    OPC_RISC_PACKW = OPC_RISC_ARITH_W | (0x4 << 12) | (0x4 << 25),

...
DEF_HELPER_2(register_thread_address_access, void, env, tl)
DEF_HELPER_4(store_conditional_u32, i32, env, tl, i32, i32)
DEF_HELPER_4(store_conditional_u64, i32, env, tl, i64, i32)
DEF_HELPER_2(hash_table_lock, void, env, tl)
DEF_HELPER_2(hash_table_unlock, void, env, tl)
DEF_HELPER_2(translate_page_aligned_address_and_fill_tlb_u32, uintptr, tl, i32)
DEF_HELPER_2(translate_page_aligned_address_and_fill_tlb_u64, uintptr, tl, i32)
DEF_HELPER_2(translate_page_aligned_address_and_fill_tlb_u128, uintptr, tl, i32)

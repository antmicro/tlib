...
{
    TCGv negatedTargetPageMask = tcg_temp_new_named("negatedTargetPageMask");
    TCGv maskedAddress = tcg_temp_new_named("maskedAddress");
                                                                ...
                                                                uint32_t memIndex, int fallbackLabel, uint8_t size)
{
     ...
     */
    TCGv_i32 memIndexVar = tcg_const_i32_named(memIndex, "memIndexVar");
    TCGv_i32 accessType = tcg_const_i32_named(WRITE, "accessType");
    if(size == 128) {
                                                          ...
                                                          uint32_t memIndex, int fallbackLabel, uint8_t size)
{
     ...
     */
    TCGv_hostptr hostAddress = tcg_temp_local_new_hostptr_named("hostAddress");
 ...
 */
void tcg_gen_atomic_compare_and_swap_host_intrinsic_i32(TCGv_i32 actual, TCGv_i32 expected, TCGv_hostptr hostAddress,
                                                        TCGv_i32 newValue, uint32_t memIndex)
{
    tcg_gen_host_atomic_cmpxchg_i32(actual, hostAddress, expected, newValue, memIndex, MO_32);
}
#endif
